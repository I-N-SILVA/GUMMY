...
ActiveRecord::Schema[7.1].define(version: 2026_11_26_000000) do
  ...
  create_table "profile_link_clicks", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["seller_profile_section_id", "clicked_on"], name: "idx_on_seller_profile_section_id_clicked_on_0bf0fc8b18"
    t.index ["seller_profile_section_id", "link_id", "clicked_on"], name: "index_profile_link_clicks_on_section_and_link_and_day", unique: true
  end
